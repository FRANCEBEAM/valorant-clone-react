  ...
  return (
    <div className='w-full fixed bg-bg-valblack p-4 py-4 flex justify-between items-center'>
        ...
        <div className='flex cursor-pointer'>
            <div className={riotClick? "fill-white group hover:fill-val-red flex items-center" : "fill-white group hover:fill-val-red flex items-center"} onClick={handleRiotClick}>
        ...
        {/* LEFT NAVBAR MENU*/}
        <div className={riotClick ? 'bg-bg-valwhite w-[484px] overflow-scroll overflow-x-hidden h-[900px] top-0 absolute p-4 py-5 left-0 transition-all ease-in-out justify-between' : "left-[-100%] relative"}>
            ...
            <div className={riotClick ? 'bg-bg-valwhite w-full relative mt-7 py-3 font-semibold uppercase font-ffmark text-base tracking-widest': "hidden"}>
               <div className='bg-gray-300/40 p-4 cursor-pointer flex justify-between' onClick={handleGamesClick}>
                    <div>Games</div>
                    <div className='flex'>
            ...
            <div className={riotClick ? 'bg-bg-valwhite w-full relative py-2 font-semibold uppercase font-ffmark text-base tracking-widest': "hidden"}>
               <div className='bg-gray-300/40 p-4 cursor-pointer flex justify-between' onClick={handleForgeClick}>
                    <div>Forge</div>
                    <div className='flex'>
            ...
            {/* ESPORTS */}
            <div className={riotClick ? 'bg-bg-valwhite w-full relative py-2 font-semibold uppercase font-ffmark text-base tracking-widest': "hidden"}>
               <div className='bg-gray-300/40 p-4 cursor-pointer flex justify-between' onClick={handleEsportsClick}>
                    <div>Esports</div>
                    <div className='flex'>
            ...
            {/* ENTERTAINMENT */}
            <div className={riotClick ? 'bg-bg-valwhite w-full relative py-2 font-semibold uppercase font-ffmark text-base tracking-widest': "hidden"}>
               <div className='bg-gray-300/40 p-4 cursor-pointer flex justify-between' onClick={handleEntertainmentClick}>
            ...
            {/* BUSINESS */}
            <div className={riotClick ? 'bg-bg-valwhite w-full relative py-2 font-semibold uppercase font-ffmark text-base tracking-widest': "hidden"}>
               <div className='bg-gray-300/40 p-4 cursor-pointer flex justify-between' onClick={handleBusinessClick}>
                    <div>Business</div>
                    <div className='flex'>
        ...
        <div className='flex items-center gap-5'>
            ...
            <div className='bg-gray-700 p-4 rounded-[18px] transition-all ease-in duration-500 cursor-pointer'>
