...
function Navbar() {
  ...
  return (
    <>
        <header>
            <div className="w-full bg-bg-valblack fixed p-4 py-4 flex items-center z-[100] justify-between">
                ...
                <div className="flex items-center">
                    <div className='cursor-pointer mr-4 hover:bg-gray-700 p-[11px] rounded-[18px]'>
                        <MdOutlineLanguage className="text-white" size={30}/>
                    </div>

                    <div className='cursor-pointer' onClick={handleClickBars}>
                        <div className='w-full bg-gray-700 p-4 rounded-[18px]'>
                          <FaBars className="text-white" size={20}/>
                        </div>
                    </div>

                    <ul className={clickbars ? 'bg-bg-valblack w-[500px] top-0 absolute right-0 z-[200px] p-4 transition-all ease-in-out duration-500' : "absolute right-[-100%]"}>
                        <div className='py-1'>
                        ...
                        <li className='pt-9 items-center relative'>
                        ...
                        <li className={infoClick ? "hover:bg-gray-700 p-4 my-4 flex uppercase font-bold tracking-widest justify-between rounded-lg text-white cursor-pointer" : "hover:bg-gray-700 text-white p-4 my-4 flex uppercase font-bold tracking-widest justify-between rounded-lg cursor-pointer"} onClick={handleInfoClick}>
                            Game Info
                            <div>
                        ...
                        <li className="hover:bg-gray-700 text-white p-4 my-4 flex uppercase font-bold tracking-widest justify-between rounded-lg cursor-pointer">
                            <Link to='/'>
                                Media
                            </Link>
                        </li>
                        ...
                        <li className={clickSupport ? "hover:bg-gray-700 p-4 my-4 flex uppercase font-bold tracking-widest justify-between rounded-lg text-white cursor-pointer" : "hover:bg-gray-700 text-white p-4 my-4 flex uppercase font-bold tracking-widest justify-between rounded-lg cursor-pointer"} onClick={handleClickSupport}>
                            Support
                            <div>
                        ...
                        <li className={clickSocials ? "hover:bg-gray-700 p-4 my-4 flex uppercase font-bold tracking-widest justify-between rounded-lg text-white cursor-pointer" : "hover:bg-gray-700 text-white p-4 my-4 flex uppercase font-bold tracking-widest justify-between rounded-lg cursor-pointer"} onClick={handleSocialsClick}>
                            Our Socials
                            <div>
                        ...
                        <div className="btn-play">
                            <button className="w-full font-ffmark font-bold tracking-widest bg-bg-valred uppercase p-4 rounded-xl hover:bg-bg-valred/80">Play Now</button>
                        </div>
                    </ul>
