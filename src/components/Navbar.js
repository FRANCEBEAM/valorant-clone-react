...
function Navbar() {
  ...
  return (
    <>
        <header>
            <div className={ click ? "w-full bg-white p-4 py-4 flex items-center justify-between ease-in duration-300" : "w-full bg-bg-valblack fixed p-4 py-4 flex items-center z-[100] justify-between"}>
                <div className='left-nav flex items-center'>
                    ...
                    <div className={click ? "hidden": "ml-6 cursor-pointer fill-white"}>
                    ...
                    <ul className={click ? "w-[460px] h-[1100px] nav-items absolute top-20 bg-white p-4 font-ffmark left-[0px] transition-all ease-in duration-500": "left-[-700px] absolute w-full z-[-100]"}>
                        
                         {/* Games */}
                        <li className={gamesClick? "bg-black p-4 my-4 flex uppercase font-semibold tracking-widest justify-between rounded-lg text-white cursor-pointer" :"nav-item bg-gray-100 p-4 my-4 flex uppercase font-semibold tracking-widest justify-between rounded-lg cursor-pointer"} onClick={handleGamesClick}>
                            Games
                        ...
                        <div>
                            <Link>
                                <img src="assets/img/navimg-1.jpeg" alt="" />
                        ...
                        <div>
                            <Link>
                                <img src="assets/img/navimg-2.jpeg" alt="" />
                ...
                {/* Close NAv */}
                <div className={click ? "cursor-pointer right-0": "hidden" } onClick={handleClick}>
                    <div className='bg-gray-200 p-4 rounded-[18px] transition-all ease-in duration-500'>
                        {clickbars ? <FaBars className="text-black" size={20} /> :  <FaTimes className="text-black" size={20}/>}
                    </div>
                </div>
                ...
                <div className={click ? "hidden" : "flex items-center"}>
                    ...
                    <div className='cursor-pointer' onClick={handleClickBars}>
                        <div className='w-full bg-gray-700 p-4 rounded-[18px]'>
                            {clickbars ? <FaTimes className="text-white" size={20}/> :  <FaBars className="text-white" size={20}/>}
                        </div>
                    </div>
                </div>
            </div>
